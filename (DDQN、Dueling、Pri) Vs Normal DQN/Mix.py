...
class MixAgent():
    ...
    def learn(self):
        ...
        q_eval_next_action = np.argmax(self.q_eval.predict(next_state), axis=1)
        ...
        # 貝爾曼方程
        q_target[batch_index, action_indices] = reward + self.gamma * q_target_pre[batch_index, q_eval_next_action] * done
